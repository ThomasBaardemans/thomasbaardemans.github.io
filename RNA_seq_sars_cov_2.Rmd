...
During my minor I attended an "Advanced Bioinformatics" course. For part of the exam each student was assigned a subset of samples from a GEO dataset to perform a RNA-seq differential expression analysis.   
...
```{r, fig.cap = "Histogram of p-values found in the results. Around 8000 genes have a p < 0.05 indicating they are differentially expressed. Looking at the background (p > 0.2) we can estimate that around 250 of 8000 genes are false positives (3%)."}
...
## Heatmap
```{r, fig.cap = "top 20 of up and down regulated genes"}
...
# **Conclusion**
Alot of genes in the A549 cells get up or down regulated when infected with the virus. Next steps would be to analyze the ferret data and analyzing what pathways the differentially expressed genes belong to.
