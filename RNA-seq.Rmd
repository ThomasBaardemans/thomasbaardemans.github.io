...
```
#Foreword
During my minor I attended a "Advanced Bioinformatics" course. For 


# Introduction

To study the effect of SARS-COV2 on the transcription of genes A549 cell lines were infected with USA-WA1/2020	SARS-COV2 virus or mock treated. This report uses data from Blanco-Melo et al., 2020 (^Daniel Blanco-Melo et al., “Imbalanced Host Response to SARS-CoV-2 Drives Development of COVID-19,” Cell 181, no. 5 (May 2020): 1036-1045.e9, https://doi.org/10.1016/j.cell.2020.04.026.)
...
```{r}
# First we obtain all the datatypes needed.

#We start with assay data (countsdata)
raw_counts_human <- read_tsv(file.path(root, "GSE147507", "GSE147507_RawReadCounts_Human.tsv.gz"))
