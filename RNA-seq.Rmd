...
```
#Foreword
During my minor I attended an "Advanced Bioinformatics" course. For the exam each student got assigned a subset of samples from a GEO dataset to perform a RNA-seq differential expression analysis.   
